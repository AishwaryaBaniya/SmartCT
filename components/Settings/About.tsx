...
import { ChevronDown, ChevronUp, BarChart3, FileText, Calendar, CheckCircle } from "lucide-react"
...
export default function About() {
  ...
  const features = [
    ...
    },
    {
      ...
      items: [
        "Accepts .nii and .nii.gz formats",
    ...
    },
    {
      ...
      items: [
        ...
        "HIPAA-compliant storage with automatic virus scanning",
